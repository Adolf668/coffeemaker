package Coffee_Maker_Test;
	...
	public class InventoryUnitTest {
	    ...
	    /**
	     * Tests Method for Chocolate Inventory Correction
	     */
	    @Test
	    public void setChocolateTest(){
	        ...
	        //Checking for the equality operator inventory count =0
	        I1.setChocolate(stockReplenishmentUnitCount);
	        currentChocCount = I1.getChocolate();
	        assertEquals(0,currentChocCount);

	        //Checking for the operator inventory count >0
	    ...
	    public synchronized void addChocolateTest() throws InventoryException{
	        ...
	        //Checking for the equality operator when input is a string value. Expected to receive an exception message.
	        try{
	            I1.addChocolate("two");
	            currentChocCount = I1.getChocolate();
	        }
	        ...
	        //Checking for the equality operator for the lower boundary input value = -1. Expected to receive an exception message.
	        try{
	        I1.addChocolate("-1");
	        currentChocCount = I1.getChocolate();
	        }
	        ...
	        //Checking for the equality operator for the acceptable input value = 2
	        I1.addChocolate("2");
	        currentChocCount = I1.getChocolate();
	    ...
	    public synchronized void enoughIngredientsTest(){
	        ...
	        try{
	            //Checking varying string input values
	        ...
	        try{
	            //Checking for values within the current inventory limits.
